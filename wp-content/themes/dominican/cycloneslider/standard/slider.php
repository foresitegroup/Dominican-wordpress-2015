    ...
    <div class="cycloneslider-slides cycle-slideshow"
        ...
        <?php foreach($slides as $slide): ?>
            <?php if ( 'image' == $slide['type'] ) : ?>
                <div class="cycloneslider-slide cycloneslider-slide-image" <?php echo $slide['slide_data_attributes']; ?> style="background: url(<?php echo $slide['image_url']; ?>) center center no-repeat; background-size: cover;">
                    ...
                    <?php if(!empty($slide['title']) or !empty($slide['description'])) : ?>
                        <div class="cycloneslider-caption"<?php if($slide['img_title'] == "center") : echo " style=\"text-align: center;\""; endif; ?>">
                            <div class="container">
